...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-30 h-24 transition-all duration-500 ease-in-out ${
        isScrolled
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className={`inline text-xl font-bold uppercase tracking-wider transition-all duration-300 ease-in-out overflow-hidden whitespace-nowrap ${
